...
class boardConfig {
     ...
     */
    boardConfig(String filename) throws FileNotFoundException {
     ...
     */
    private boardConfig(boardConfig copy) {
        this.dim = copy.dim;
     ...
     */
    Collection<boardConfig> getSuccessors() {
        //TODO add pruning
        //TODO fix this function
        ArrayList<boardConfig> successors = new ArrayList<>();
        if(canMove()) {
            boardConfig b1 = new boardConfig(this);
            boardConfig b2 = new boardConfig(this);
            b1.moveCursor();
            b2.moveCursor();
